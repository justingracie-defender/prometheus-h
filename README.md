...
### Key Features
- **Parent Authority**: Full override. 
- **Child Safety**: Network monitoring, purchase blocking, alerts.
- **Emergency Protection**: Acts to shield in imminent danger, then reports.
- **Privacy First**: Logs auto-delete where possible.
- **Gentle by Design**: 10cm/s speed, 60N force limit.
