...
4. **Repo Sync**: Add `MANIFESTO.md` to repo root and reference outreach steps in `ROADMAP.md` for transparency.
5. **Iteration**: Monitor feedback for 7 days. Use substantive critiques to scope v0.3 edge-case work from Repilka’s review.

### Technical Milestones

- **v0.2 Hardening**: Distributed consistency, bootstrap attack mitigation, Covenant mapping. See section above.
