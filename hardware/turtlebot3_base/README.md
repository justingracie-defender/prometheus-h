...
Trusted Friend v1.7.1-HardwareSteel may use TurtleBot3-style mobile-base concepts and OpenCR-style hardware organization as references, but this repository does not vendor third-party TurtleBot3 or OpenCR files in this update.

| Reference | Use in Trusted Friend | Boundary |
| --- | --- | --- |
...
| Trusted Friend custom layer | ESP32 v1.7.0c ROM, Button+PIN interlock, smoke/CO interrupt, current sensing, Layer 1 no-OTA boundary. | This is the actual HardwareSteel scope for v1.7.1. |
